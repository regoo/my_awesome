...
## 办公效率
* [shotcut](https://github.com/mltframework/shotcut) -跨平台开源视频编辑器（基于QT）

* [SurveyKing](https://github.com/javahuang/SurveyKing) 功能强大的调查问卷系统和考试系统
...
- [rsync-time-backup](https://github.com/laurent22/rsync-time-backup) 使用 rsync 进行时间机器式备份。
...
* [sourcegraph](https://github.com/sourcegraph/sourcegraph) 智能代码编写平台
...
## Editors
 ...
 。  [AFFiNE](https://github.com/toeverything/AFFiNE ) 下一代知识库，它将规划、分类和创建结合在一起。隐私至上、开源、可定制且随时可用。
...
* [ZooKeeper](http://zookeeper.apache.org/) - ZooKeeper is a centralized service for maintaining configuration information, naming, providing distributed synchronization, and providing group services.
  ...
  [winsw](https://github.com/winsw/winsw)  WinSW将任何应用程序作为 Windows服务进行包装和管理。
